...
void test_max_segment_tree(){
    ...
    assert(st.query(2,4) == 10);
    assert(st.query(0,4) == 10);
}

void test_segment_tree_addition(){
    int n = 5;
    vi v(n);
    rep(i,0,n){
        v[i] = i;
    ...
    assert(st.query(1,1) == 1);
    assert(st.query(2,2) == 4);
    assert(st.query(3,3) == 11);
    assert(st.query(4,4) == -2);

    assert(st.query(2,3) == 15);
    assert(st.query(0,2) == 7);
    assert(st.query(2,4) == 13);
